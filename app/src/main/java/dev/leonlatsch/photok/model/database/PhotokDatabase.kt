 ...
 * * NOTE: exportSchema is set to false to allow building without previous JSON schemas.
 * autoMigrations are removed because JSON history is missing in the browser environment.
 */
@Database(
    entities = [
        Photo::class,
    ...
    exportSchema = false // CRITICAL: This bypasses the 6.json error
)
